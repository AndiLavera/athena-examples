      ...
      this.ActionCable = {
        ...
        log: function () {
          ...
          if (this.debugging) {
            ...
            return (ref = this.logger).log.apply(
              ref,
              ["[ActionCable]"].concat(slice.call(messages))
            );
          }
        },
      };
    ...
    (function () {
      ...
      ActionCable.ConnectionMonitor = (function () {
        ...
        ConnectionMonitor.prototype.connectionIsStale = function () {
          var ref;
          return (
            secondsSince((ref = this.pingedAt) != null ? ref : this.startedAt) >
            this.constructor.staleThreshold
          );
        };
    ...
    (function () {
      ...
      ActionCable.Connection = (function () {
        ...
        Connection.prototype.isProtocolSupported = function () {
          var ref1;
          return (
            (ref1 = this.getProtocol()),
            indexOf.call(supportedProtocols, ref1) >= 0
          );
        };
        ...
        Connection.prototype.getState = function () {
          ...
          for (state in WebSocket) {
            ...
            if (
              value ===
              ((ref1 = this.webSocket) != null ? ref1.readyState : void 0)
            ) {
    ...
    (function () {
      ...
      ActionCable.Subscriptions = (function () {
        ...
        Subscriptions.prototype.create = function (channelName, mixin) {
          ...
          subscription = new ActionCable.Subscription(
            this.consumer,
            params,
            mixin
          );
        ...
        Subscriptions.prototype.notifyAll = function () {
          ...
          for (i = 0, len = ref.length; i < len; i++) {
            ...
            results.push(
              this.notify.apply(
                this,
                [subscription, callbackName].concat(slice.call(args))
              )
            );
          }
          return results;
